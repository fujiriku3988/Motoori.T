#include "main.h"
#include"Planets/Earth/Earth.h"
#include"Planets/Moon/Moon.h"
#include"Planets/Sun/Sun.h"
...
void Application::Update()
{
	...
	//どれだけ傾けているか
	Math::Matrix _mRoatationX = Math::Matrix::CreateRotationX(DirectX::XMConvertToRadians(30));
	Math::Matrix _mRoatationY = Math::Matrix::CreateRotationY(DirectX::XMConvertToRadians(0));

	//基準点（ターゲット）からどれだけ離れているか
	Math::Matrix _mTrans = Math::Matrix::CreateTranslation(0, 20, -40);
	...
	for (std::shared_ptr<KdGameObject>objList : m_objList)
	{
		objList->Update();
	}
}
